...
def get_the_dataset(dataset_name):
    data_call = {"coco": coco_dataloader.return_coco,
                 ...
                 "aro": arochecklist_dataloader.return_aroattribute,
...
def create_messages(prompts):
    ...
    main_prompt2 = "Given an input context describing a scene, your task is to paraphrase the sentence and then create a new sentence with very similar meaning."
    main_prompt3 = "The new sentence must meet the following three requirements: \n 1. It must be fluent and grammatically correct. \n 2. It must make logical sense. \n 3. It must have the same meaning as the original sentence."
    main_prompt4 = "Here is one example: \n Sentence: A man and a woman are walking together. \n Answer: A man is walking with a woman."
    main_prompt5 = "Explanation: The original sentence and new sentence are not exactly same but their meaning is same. Further, the new sentence is fluent and grammatically correct, and it makes logical sense."
