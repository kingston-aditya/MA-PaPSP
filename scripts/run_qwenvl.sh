...
accelerate launch --num_processes 2 --num_machines 1 --mixed_precision fp16 --main_process_port 29501 /nfshomes/asarkar6/aditya/JANe/inference/lvlms/run_qwenvl.py \
